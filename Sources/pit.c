...
void PIT0_Init  (tPIT_CH volatile ch, uint32 volatile loadValue,uint8 volatile ip, PIT_CH_CALLBACK volatile pCallback)
{
...
void PIT1_Init  (tPIT_CH volatile ch, uint32 volatile loadValue,uint8 volatile ip, 
                 PIT_CH_CALLBACK volatile pCallback)
{
  /* interrupt configuration                                                  */
...
void PIT2_Init  (tPIT_CH volatile ch, uint32 volatile loadValue,uint8 volatile ip, 
                 PIT_CH_CALLBACK volatile pCallback)
{
  /* interrupt configuration                                                  */
...
void PIT3_Init  (tPIT_CH volatile ch, uint32 volatile loadValue,uint8 volatile ip, 
                 PIT_CH_CALLBACK volatile pCallback)
{
  /* interrupt configuration                                                  */
...
{ 
  ...
  dummy = PIT_TCTRL0;               /* dummy read TCTRL0                      */ 
...
{ 
  ...
  dummy = PIT_TCTRL1;               /* dummy read TCTRL1                      */ 
  /* process interrupt callback function                                      */  
...
{ 
  ...
  dummy = PIT_TCTRL2;               /* dummy read TCTRL2                      */ 
  /* process interrupt callback function                                      */  
...
{ 
  ...
  dummy = PIT_TCTRL3;               /* dummy read TCTRL3                      */ 
  /* process interrupt callback function                                      */  
