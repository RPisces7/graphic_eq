 ...
 * @param   loadValue - 16-bit load register value 
 * @return  none
 ...
 ******************************************************************************/    
extern void PIT0_Init  (tPIT_CH volatile ch, uint32 volatile loadValue, uint8 volatile ip, PIT_CH_CALLBACK volatile pCallback);
extern void PIT1_Init  (tPIT_CH volatile ch, uint32 volatile loadValue, 
                        uint8 volatile ip, PIT_CH_CALLBACK volatile pCallback);
extern void PIT2_Init  (tPIT_CH volatile ch, uint32 volatile loadValue, 
                        uint8 volatile ip, PIT_CH_CALLBACK volatile pCallback);
extern void PIT3_Init  (tPIT_CH volatile ch, uint32 volatile loadValue, 
                        uint8 volatile ip, PIT_CH_CALLBACK volatile pCallback);
